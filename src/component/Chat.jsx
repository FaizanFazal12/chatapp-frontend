...
import SendVideoCallRequest from "./SendVideoCallRequest";
...
const Chat = ({ sender, selectedUser }) => {
  ...
  const [
    ...
    { isLoading: isSendingMessageWithAttachment },
  ] = useSendMessageWithAttachmentMutation();
      ...
      >
        {audioBlob ? (
          ...
          <>
            ...
            <label
              htmlFor="attachment"
              className="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full cursor-pointer"
            >
